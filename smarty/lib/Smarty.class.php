...
function inicializeSmarty($new_smarty){
    $new_smarty->setTemplateDir('smarty/templates');
    $new_smarty->setCompileDir('smarty/templates_c');
    $new_smarty->setCacheDir('smarty/cache');
    $new_smarty->setConfigDir('smarty/config');
}
